        ...
        <>
            <div className="filter-product">
                <div className="filter-product__head">
                    <h4>Filter</h4>
                    <button className="filter-content__button" onClick={()=>{setIsFilterActive(!isFilterActive)}}><i class="fa-solid fa-filter"></i></button>
                </div>
                <form className={isFilterActive?"filter-container active":"filter-container"}>
                    <div className="filter-content">
                    <div className="my-3 display-flex flex-row justify-content-space-between align-items-center">
                    <h4>FILTER BY PRICE</h4>
                    <button className="filter-content__button">filter</button>
                    </div>
                        <div className="filter-price">
                            <label htmlFor="min-price">Min: <input type="number" class="price" name="min-price" id="min-price" /></label>
                            <span className="separator mx-2 display-flex flex-row justify-content-center align-items-center"> - </span>
                            <label htmlFor="max-price">Max: <input type="number" class="price " name="max-price" id="max-price" /></label>
                        </div>
                    </div>
                    <div className="filter-content">
                    <h4 className='my-3'>Sort Product</h4>
                    <select name="select" id="select" class="filter-category">
